...
[Installation Instructions](https://github.com/dbix-project/go-dubaicoin/wiki/Building-Dubaicoin)
on the wiki.

Building gdbix requires both a Go and a C compiler.
...
Go Dubaicoin comes with several wrappers/executables found in
[the `cmd` directory](https://github.com/dbix-project/go-dubaicoin/tree/develop/cmd):

* `gdbix` Dubaicoin CLI (dubaicoin command line interface client)
* `bootnode` runs a bootstrap node for the Discovery Protocol
* `exptest` test tool which runs with the [tests](https://github.com/dbix-project/tests) suite:
  `/path/to/test.json > exptest --test BlockTests --stdin`.
* `evm` is a generic Dubaicoin Virtual Machine: `evm -code 60ff60ff -gas
 ...
 * Start up 's built-in interactive [JavaScript console](https://github.com/dbix-project/go-dubaicoin/wiki/JavaScript-Console),
...
[ specific APIs](https://github.com/dbix-project/go-dubaicoin/wiki/Management-APIs)). These can be
...
`gdbix` can be configured via command line options, environment variables and config files.

If you'd like to contribute to go-dubaicoin, please fork, fix, commit and send a pull request
for the maintainers to review and merge into the main code base. If you wish to submit more
complex changes though, please check up with the core devs first on [our gitter channel](https://gitter.im/dbix-project/go-dubaicoin)
 ...
 * Commit messages should be prefixed with the package(s) they modify.
   * E.g. "dbix, rpc: make trace configs optional"


Please see the [Developers' Guide](https://github.com/dbix-project/go-dubaicoin/wiki/Developers'-Guide)
for more details on configuring your environment, managing project dependencies and testing procedures.

## License

The go-dubaicoin library (i.e. all code outside of the `cmd` directory) is licensed under the
[GNU Lesser General Public License v3.0](http://www.gnu.org/licenses/lgpl-3.0.en.html), also
included in our repository in the `COPYING.LESSER` file.

The go-dubaicoin binaries (i.e. all code inside of the `cmd` directory) is licensed under the
